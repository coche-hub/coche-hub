...
class CommunityService(BaseService):
    ...
    def create_community(self, name: str, description: str, creator_id: int, logo: Optional[str] = None) -> Community:
        ...
        created_community = self.repository.create(name=name,
    ...
    def update_community(self, community_id: int, name: Optional[str] = None, 
                        description: Optional[str] = None, logo: Optional[str] = None) -> Community:
    ...
    def add_curator(self, community_id: int, user_id: int, requester_id: int = None) -> CommunityCurator:
        ...
        return self.curator_repository.add_curator(community_id, user_id)
