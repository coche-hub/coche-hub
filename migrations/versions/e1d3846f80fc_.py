...
Revision ID: e1d3846f80fc
Revises: 
Create Date: 2025-11-29 20:05:04.520729
...
def upgrade():
    ...
    sa.Column('email_2fa_enabled', sa.Boolean(), nullable=False),
    ...
    sa.Column('DataSetType', sa.String(length=50), nullable=False),
    sa.ForeignKeyConstraint(['ds_meta_data_id'], ['ds_meta_data.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
